...
const ClientWork      = dynamic(() => import("@/app/components/sections/ClientWork"),      { loading: () => <div className="h-[600px]" style={{ background: "#101a2e" }} /> });
...
const MarqueeBanner   = dynamic(() => import("@/app/components/sections/MarqueeBanner"),   { loading: () => <div className="h-20" style={{ background: "#101a2e" }} /> });
