            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <a href="tel:012043-76696" className="text-sm text-gray-400 hover:text-white transition-colors">
                    0120-43-76696
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <a href="mailto:info@isdcouncil.com" className="text-sm text-gray-400 hover:text-white transition-colors">
                    info@isdcouncil.com
                  </a>
                </li>
                <li className="flex items-start gap-3">
